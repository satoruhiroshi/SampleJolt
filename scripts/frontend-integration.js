 ...
 * This file demonstrates how to integrate Samplejolt with a web frontend
 */

// For React/Vue/Angular applications
export class SamplejoltClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SamplejoltClient(provider, contractAddress);
